...
In the Try It Yourself after Listing 5.5 point 2 lists starting the server with `node server.js`. This should read death `node client.js` (thanks to L Nestor).
